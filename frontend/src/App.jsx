...
const bangkokData = {
  ...
  "สาทร": ["ทุ่งมหาเมฆ","ทุ่งวัดดอน","ยานนาวา","ช่องนนทรี","บางโพงพาง","ทุ่งมหาเมฆ"],
  ...
  "ลาดพร้าว": ["ลาดพร้าว","จรเข้บัว"],
  "สาทร": ["ทุ่งมหาเมฆ","ทุ่งวัดดอน","ยานนาวา","ช่องนนทรี","บางโพงพาง"],
  "บางนา": ["บางนา"],
...
const allDistricts = [
  ...
  "สัมพันธวงศ์","ลาดพร้าว","วังทองหลาง","คลองสาน","ตลิ่งชัน",
  "บางกอกน้อย","บางขุนเทียน","ภาษีเจริญ","หนองแขม","ราษฎร์บูรณะ",
  "หลักสี่","จตุจักร","บางซื่อ","บึงกุ่ม","สาทร","บางคอแหลม",
  "ประเวศ","คลองเตย","สวนหลวง","ดอนเมือง","บางพลัด","ดินแดง",
  "ทวีวัฒนา","บางแค","บางนา","ทุ่งครุ","บางบอน","วัฒนา",
];
            ...
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px" }}>
                ...
                <h2 style={{
                  fontFamily: "'Kanit', sans-serif", fontWeight: "600",
                  fontSize: "18px", color: "#1a1a2e", margin: 0, lineHeight: 1.3
                }}>คุณเดินทางด้วยวิธีอะไร? <span style={{ fontWeight: "300", fontSize: "14px", color: "#aaa" }}>(เลือกได้หลายอย่าง)</span></h2>
              </div>
